...
import { ChevronUp, Menu, X, BookOpen, Users, Target, Award, Phone, Mail, MapPin, Facebook, Twitter, Instagram, Linkedin, Play, CheckCircle, Star, ArrowRight, MessageCircle, Code, Database, Cloud, Smartphone, Layers, Palette, FileSpreadsheet, BarChart, Coffee, Zap, Globe, Shield, Sparkles } from 'lucide-react';
...
const App = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const sections = ['hero', 'about', 'courses', 'approach', 'why-choose', 'testimonials', 'cta', 'faq'];
  ...
  const courses = [
    {
      ...
      description: "Master real-world business analysis and decision-making skills with hands-on projects",
    ...
    },
    {
      ...
      description: "Build AI models and solve complex problems ethically with cutting-edge techniques",
    ...
    },
    {
      ...
      description: "Create cross-platform mobile applications with native performance",
    ...
    },
    {
      ...
      description: "Develop smart contracts and decentralized applications for Web3",
    ...
    },
    {
      ...
      description: "Master advanced Excel techniques for business analytics and automation",
    ...
    },
    {
      ...
      description: "Create interactive business intelligence dashboards and reports",
    ...
    },
    {
      ...
      description: "Build strong programming foundations with Python for various applications",
  ...
  const learningApproach = [
    {
      ...
      description: "Complex concepts simplified through relatable memes and visual aids that stick in memory"
    },
    {
      icon: "🎯",
      title: "Interactive Sessions",
      description: "Engaging live sessions with real-time problem solving and collaborative learning"
    },
    {
      icon: "🚀",
      title: "Real-World Projects",
      description: "Build portfolio-worthy projects with industry mentorship and practical applications"
    },
    {
      icon: "🏆",
      title: "Hackathons",
      description: "Compete, collaborate, and showcase your skills in exciting coding challenges"
    },
    {
      icon: "💡",
      title: "Gamified Learning",
      description: "Earn points, badges, and rewards as you progress through your learning journey"
    },
    {
      icon: "🎨",
      title: "Creative Challenges",
      description: "Think outside the box with innovative problem-solving and creative projects"
    }
  ];
  ...
  const testimonials = [
    {
      ...
      rating: 5,
      comment: "The meme-based learning approach made complex SQL queries so much easier to understand. I never thought learning could be this fun and effective!",
      avatar: "👩‍💻",
    ...
    },
    {
      ...
      rating: 5,
      comment: "From zero to building my first web app in just 3 months. The project-based approach and mentorship were absolute game-changers for my career.",
      avatar: "👨‍💻",
      company: "StartupXYZ"
    },
    {
      ...
      rating: 5,
      comment: "The hands-on projects and hackathons gave me real industry experience. Landed my dream job at a top tech company within weeks of completion!",
      avatar: "👩‍🔬",
  ...
  const faqs = [
    {
      ...
      answer: "Absolutely! All our courses start from fundamentals and gradually progress to real-world applications. No prior experience required - we'll guide you every step of the way."
    },
    {
      question: "Will I get a certificate?",
      answer: "Yes, you'll receive an AICTE-approved certificate upon successful completion of the course and projects. This certification is recognized by industry leaders."
    },
    {
      question: "Is job assistance provided?",
      answer: "Definitely! We provide comprehensive placement support including resume review, mock interviews, job alerts, and direct connections with our hiring partners."
    },
    {
      question: "How are memes and activities used in learning?",
      answer: "We use topic-specific memes, interactive quizzes, and fun challenges to make complex concepts memorable and engaging. Learning becomes enjoyable and effective."
    },
    {
      question: "Can I access content after completion?",
      answer: "Yes, you get lifetime access to all course materials, updates, and our exclusive alumni community for continued learning and networking."
    },
    {
      question: "Do you offer online and offline modes?",
      answer: "Yes, we offer hybrid learning with recorded sessions, live classes, and in-person bootcamps for a comprehensive and flexible learning experience."
    }
  ];
    ...
    <div className="min-h-screen bg-white overflow-x-hidden">
        ...
        <div className="container mx-auto px-2 sm:px-6 text-center relative z-10 max-w-6xl">
          <div className="space-y-2 scroll-animate opacity-0 translate-y-5 transition-all duration-1200 ease-out">
            ...
            <p className="text-lg sm:text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              Transform your future with meme-based learning, real-world projects, and industry-ready skills. 
              Join thousands of students who chose fun over boring education.
            </p>
        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10">
          <div className="text-center mb-12 sm:mb-16 scroll-animate opacity-0 translate-y-12 transition-all duration-1200 ease-out">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-800 mb-4 sm:mb-6">
              About <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-600 to-emerald-600">Vishnuspire LLP</span>
            </h2>
            <p className="text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto">
              We are Vishnuspire LLP — a future-ready EdTech platform transforming how students learn and grow.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 items-center mb-12 sm:mb-16">
            <div className="space-y-6 scroll-animate opacity-0 translate-x-12 transition-all duration-1200 ease-out delay-300">
              <div className="bg-white/40 backdrop-blur-sm p-6 rounded-2xl shadow-lg border border-green-200/30 hover:shadow-xl transition-all duration-500 ease-out">
                ...
                <p className="text-gray-600 leading-relaxed">
                  "Learning should feel like a journey you enjoy." We aim to build a space where students engage, 
                  laugh, build, and grow, turning passive learners into confident, curious creators.
                </p>
              </div>
              <div className="bg-white/40 backdrop-blur-sm p-6 rounded-2xl shadow-lg border border-emerald-200/30 hover:shadow-xl transition-all duration-500 ease-out">
                ...
                <p className="text-gray-600 leading-relaxed">
                  To redefine education through interactive, industry-driven, exciting methods. 
                  Blending memes, real-world projects, and mentorship to prepare future-ready professionals.
                </p>
              </div>
            </div>
            <div className="grid grid-cols-2 gap-4 sm:gap-6 scroll-animate opacity-0 translate-x-12 transition-all duration-1200 ease-out delay-500">
              <div className="text-center p-4 sm:p-6 bg-gradient-to-br from-green-100/30 to-emerald-100/30 backdrop-blur-sm rounded-2xl shadow-lg hover:shadow-xl transition-all duration-500 ease-out transform hover:-translate-y-2">
                ...
                <div className="text-gray-600 text-sm sm:text-base">Advanced Courses</div>
              </div>
              <div className="text-center p-4 sm:p-6 bg-gradient-to-br from-emerald-100/30 to-lime-100/30 backdrop-blur-sm rounded-2xl shadow-lg hover:shadow-xl transition-all duration-500 ease-out transform hover:-translate-y-2">
                <div className="text-2xl sm:text-3xl font-bold text-emerald-600 mb-2">10K+</div>
                <div className="text-gray-600 text-sm sm:text-base">Happy Students</div>
              </div>
              <div className="text-center p-4 sm:p-6 bg-gradient-to-br from-lime-100/30 to-green-100/30 backdrop-blur-sm rounded-2xl shadow-lg hover:shadow-xl transition-all duration-500 ease-out transform hover:-translate-y-2">
                <div className="text-2xl sm:text-3xl font-bold text-lime-600 mb-2">95%</div>
                <div className="text-gray-600 text-sm sm:text-base">Placement Rate</div>
              </div>
              <div className="text-center p-4 sm:p-6 bg-gradient-to-br from-green-100/30 to-emerald-100/30 backdrop-blur-sm rounded-2xl shadow-lg hover:shadow-xl transition-all duration-500 ease-out transform hover:-translate-y-2">
      ...
      <section id="courses" className="py-16 sm:py-20 relative">
        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10">
          <div className="text-center mb-12 sm:mb-16 scroll-animate opacity-0 translate-y-12 transition-all duration-1200 ease-out">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-800 mb-4 sm:mb-6">
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-600 to-emerald-600">Vishnuspire</span> Courses
            </h2>
            <p className="text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto">
              12 industry-aligned courses designed to make you job-ready with hands-on projects and real-world applications.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-6">
            {courses.map((course, index) => (
              ...
              >
                ...
                <h3 className="text-lg sm:text-xl font-bold text-gray-800 mb-3 group-hover:text-green-700 transition-colors duration-500 ease-out">{course.title}</h3>
                <p className="text-gray-600 text-sm mb-4 leading-relaxed">{course.description}</p>
                <div className="flex flex-wrap gap-1 mb-4">
                  {course.tools.slice(0, 3).map((tool, toolIndex) => (
                    <span key={toolIndex} className="text-xs bg-white/60 backdrop-blur-sm px-2 py-1 rounded-lg text-green-700 font-medium shadow-sm">
                      {tool}
                    </span>
                  ))}
      ...
      <section id="approach" className="py-16 sm:py-20 relative">
        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10">
          <div className="text-center mb-12 sm:mb-16 scroll-animate opacity-0 translate-y-12 transition-all duration-1200 ease-out">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-800 mb-4 sm:mb-6">
              The <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-600 to-emerald-600">Vishnuspire</span> Approach
            </h2>
            <p className="text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto">
            ...
            <div className="flex space-x-4 sm:space-x-6 min-w-max lg:grid lg:grid-cols-3 lg:gap-6 lg:min-w-0">
              {learningApproach.map((item, index) => (
                ...
                >
                  ...
                  <h3 className="text-lg sm:text-xl font-bold text-gray-800 mb-3 group-hover:text-green-700 transition-colors">{item.title}</h3>
      ...
      <section id="why-choose" className="py-16 sm:py-20 relative">
        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10">
          <div className="text-center mb-12 sm:mb-16 scroll-animate opacity-0 translate-y-12 transition-all duration-1200 ease-out">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-800 mb-4 sm:mb-6">
              Why Thousands Trust <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-600 to-emerald-600">Vishnuspire</span>
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
            {[
              ...
              >
                ...
                <span className="text-gray-700 text-sm sm:text-base leading-relaxed group-hover:text-gray-800 transition-colors duration-500 ease-out">{item}</span>
              </div>
            ))}
          </div>
        </div>
            ...
            {testimonials.map((testimonial, index) => (
              ...
              >
                <div className="flex items-center mb-4">
                  <div className="text-2xl sm:text-3xl mr-4 bg-green-100/60 backdrop-blur-sm p-3 rounded-full group-hover:scale-110 transition-transform duration-500 ease-out">{testimonial.avatar}</div>
                  <div>
                    <h4 className="font-bold text-gray-800 text-sm sm:text-base">{testimonial.name}</h4>
                    <p className="text-xs sm:text-sm text-green-600 font-medium">{testimonial.course}</p>
                ...
                <p className="text-gray-700 italic text-sm sm:text-base leading-relaxed">"{testimonial.comment}"</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section id="cta" className="py-16 sm:py-20 relative overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div 
            ...
            style={{
              transform: `translate(${-scrollY * 0.008}px, ${-scrollY * 0.01}px)`,
            }}
          />
        </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 text-center relative z-10 scroll-animate opacity-0 translate-y-12 transition-all duration-1200 ease-out">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4 sm:mb-6 text-white">
            Ready to Start Your <span className="text-lime-200">Vishnuspire</span> Journey?
          </h2>
          <p className="text-lg sm:text-xl mb-6 sm:mb-8 max-w-2xl mx-auto text-green-50 leading-relaxed">
            Join thousands of students who chose Vishnuspire to learn differently. Start your transformation today!
          </p>
      ...
      <section id="faq" className="py-16 sm:py-20 relative">
        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10">
          ...
          <div className="max-w-4xl mx-auto">
            {faqs.map((faq, index) => (
              <div key={index} className="mb-4 scroll-animate opacity-0 translate-y-12 transition-all duration-1200 ease-out" style={{ transitionDelay: `${index * 0.15}s` }}>
                <button
                ...
                >
                  <span className="font-semibold text-gray-800 text-sm sm:text-base pr-4 group-hover:text-green-700 transition-colors duration-500 ease-out">{faq.question}</span>
                  <ChevronUp className={`w-5 h-5 text-green-600 transition-transform duration-500 ease-out flex-shrink-0 ${openFaq === index ? 'rotate-180' : ''}`} />
                </button>
                {openFaq === index && (
      ...
      <footer className="bg-gradient-to-br from-green-800/95 to-emerald-900/95 backdrop-blur-sm text-white py-12 sm:py-16 relative overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden">
          <div 
            ...
            style={{
              transform: `translate(${scrollY * 0.005}px, ${scrollY * 0.003}px)`,
            }}
          />
          <div 
            className="absolute -bottom-20 -left-20 w-60 h-60 bg-emerald-400/10 rounded-full blur-xl"
            style={{
              transform: `translate(${-scrollY * 0.003}px, ${-scrollY * 0.005}px)`,
            }}
          />
        </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10 scroll-animate opacity-0 translate-y-12 transition-all duration-1200 ease-out">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            <div className="lg:col-span-1">
              ...
              <p className="text-green-200 mb-4 text-sm sm:text-base leading-relaxed">
                Transforming education through meme-based learning and real-world projects.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="#" className="text-green-200 hover:text-white transition-colors text-sm sm:text-base">About Us</a></li>
                <li><a href="#" className="text-green-200 hover:text-white transition-colors text-sm sm:text-base">Courses</a></li>
                <li><a href="#" className="text-green-200 hover:text-white transition-colors text-sm sm:text-base">Admissions</a></li>
                <li><a href="#" className="text-green-200 hover:text-white transition-colors text-sm sm:text-base">Placements</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="#" className="text-green-200 hover:text-white transition-colors text-sm sm:text-base">Help Center</a></li>
                <li><a href="#" className="text-green-200 hover:text-white transition-colors text-sm sm:text-base">Contact Us</a></li>
                <li><a href="#" className="text-green-200 hover:text-white transition-colors text-sm sm:text-base">Privacy Policy</a></li>
                <li><a href="#" className="text-green-200 hover:text-white transition-colors text-sm sm:text-base">Terms of Service</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <div className="space-y-3">
                <div className="flex items-center">
                  ...
                  <span className="text-green-200 text-sm sm:text-base">+91 12345 67890</span>
                </div>
                <div className="flex items-center">
                  <Mail className="w-4 h-4 sm:w-5 sm:h-5 mr-3 text-green-300 flex-shrink-0" />
                  <span className="text-green-200 text-sm sm:text-base">info@vishnuspire.com</span>
                </div>
                <div className="flex items-center">
                  <MapPin className="w-4 h-4 sm:w-5 sm:h-5 mr-3 text-green-300 flex-shrink-0" />
                  <span className="text-green-200 text-sm sm:text-base">Bangalore, India</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="border-t border-green-700/50 mt-8 sm:mt-12 pt-6 sm:pt-8 text-center">
            <p className="text-green-200 text-sm sm:text-base">
              © 2024 Vishnuspire LLP. All rights reserved. | AICTE Approved Institution
            </p>
          </div>
        </div>
      </footer>
